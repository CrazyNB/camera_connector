...
internal const val PREVIEW_MAX_DIMENSION_PX = 512
...
internal const val RAW_ORIENTATION_READ_LIMIT_BYTES = 512 * 1024
internal const val TIFF_HEADER_SCAN_LIMIT_BYTES = 4096
internal const val TIFF_HEADER_BYTES = 8
internal const val TIFF_MAGIC = 42
internal const val TIFF_IFD_ENTRY_BYTES = 12
internal const val TIFF_ORIENTATION_TAG = 0x0112
internal const val TIFF_SHORT_TYPE = 3
internal const val JPEG_SOI_BYTES = 3
