...
$requiredJniFunctions = @(
    ...
    "Java_com_cameraconnector_app_core_NativeMobileCore_promptProfilesForProjectJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_globalPromptProfilesJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_forkGlobalPromptProfileJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_saveGlobalPromptVersionJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_forkPromptProfileJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_savePromptVersionJson",
