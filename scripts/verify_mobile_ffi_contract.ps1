...
$requiredFunctions = @(
    ...
    "camera_connector_mobile_core_score_asset_group_preview_json",
    "camera_connector_mobile_core_recommend_burst_group_json",
    ...
    "camera_connector_mobile_core_strategy_profiles_json",
    "camera_connector_mobile_core_save_strategy_profile_json",
...
$requiredJniFunctions = @(
    ...
    "Java_com_cameraconnector_app_core_NativeMobileCore_projectSelectsAssetGroupPageJson",
    ...
    "Java_com_cameraconnector_app_core_NativeMobileCore_scoreAssetGroupPreviewJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_recommendBurstGroupJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_acceptRecommendedBestJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_markBurstNeedsReviewJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_restoreAutomaticRecommendationJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_clearRecommendationJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_keepAllCandidatesJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_hideLowScoreCandidatesJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_overrideRecommendedBestJson",
    ...
    "Java_com_cameraconnector_app_core_NativeMobileCore_strategyProfilesJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_saveStrategyProfileJson",
    "Java_com_cameraconnector_app_core_NativeMobileCore_reviewQueueSummaryJson",
