...
$requiredJniFunctions = @(
    ...
    "Java_com_cameraconnector_app_core_NativeMobileCore_deleteProjectGroupJson",
    ...
    "Java_com_cameraconnector_app_core_NativeMobileCore_createManualBurstGroupJson",
