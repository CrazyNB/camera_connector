...
| RX-014A | Dashboard read-model | P0 | Core exposes one dashboard query for UI shells with receiver status, connected devices, filtered asset summary, and paged asset groups |
