...
Dashboard output includes receiver status, config/state/output paths, safe account summaries, transfer health counts, recent failed transfers, connected devices, asset summary, and paged assets.
